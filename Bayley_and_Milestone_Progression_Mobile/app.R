                       ...
                       sidebarLayout(
                         ...
                         mainPanel(
                           fluidRow(column(12, 
                                    ...
                                    fluidRow(column(12, tags$p("Individual Milestones plotted atop SCT percentiles calculated from the eXtraordinarY Babies Study cohort."), style = "text-align: center; padding: 20px;"),
                                             column(12,
                                                    br(),),
                                             column(12,
                                                    tags$div(
